...
foreach ($trams as $tram) {
       ...
       )
    {
        ...
        ($tram[1] == 'ТС-77')             ||   // он же ЛМ-68МЧ, нет точных данных, но на низкопольный не похож
        ($tram[1] == 'ЛВС-86К')           ||
        ($tram[1] == 'ЛВС-86М2')          ||
        ($tram[1] == 'ЛВС-86К-М')         ||
    ...
    <body>
        <center>
            ...
            <small>
                ...
                а также ЛМ-99 (кроме модификации АВН) и ТС-77 (он же ЛМ-68МЧ, по поводу него нет точных данных).<br/>
<!--
                Полностью высокопольными считаются ЛВС-86 и ЛВС-97 (во всех модификациях),<br/>
